...
public class CheckingAccount extends Account {
    ...
    public CheckingAccount(String accountAgency, String accountNumber, Client client, double accountBalance) {
        super(accountAgency, accountNumber, client, accountBalance);
        super.setAccountTax(11);
    }

    public void setAccountTax(double accountTax) {
        this.tax = accountTax;
    }
